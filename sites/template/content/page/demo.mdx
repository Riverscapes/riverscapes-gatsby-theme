...
Using a relative path to navigate relative to the mdx file.
...
// NOTE: <img> tags won't work for this
...
Or if you need a bit more control you can use the HTML
...
* Do not use the `<Container />` component as it will fight with the site's template and responsiveness
